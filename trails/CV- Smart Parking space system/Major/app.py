"""Streamlit dashboard: Qwen2.5-VL parking occupancy detection.
...
st.title("🚗 Smart Parking Space Detection — Qwen2.5-VL")

REF_FRAME_PATH = "reference_frame.jpg"


@st.cache_resource(show_spinner="Loading Qwen2.5-VL model (first run only)...")
def get_classifier():
